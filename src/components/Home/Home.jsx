              ...
              <TrackVisibility>
                {({ isVisible }) =>
                  <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                    ...
                    <p>An aspiring programmer and recent graduate actively seeking challenging roles to apply and enhance my coding skills. I'm passionate about continuous learning, seeking guidance from experienced professionals. Committed to hands-on projects, I believe in the power of practical experience for professional growth</p>
                    {/* <HashLink to='#connect' className="text-decoration-none pt-0 mt-0"> */}
