              ...
              <TrackVisibility>
                {({ isVisible }) =>
                  <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                    ...
                    <p>Motivated frontend developer with 6 months of experience creating responsive and user-friendly web applications. Proficient in HTML, CSS, JavaScript, and React.js. Enthusiastic about continuous learning and professional development, with proven ability to collaborate effectively with design and product teams to deliver high-quality projects.</p>
